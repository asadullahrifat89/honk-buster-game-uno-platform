...
{
    public partial class PlayerRocketSeeking : SeekingRocketBase
    {
        #region Fields
            ...
            Action<GameObject> recycleAction)
        {
            ...
            _bombUris = Constants.CONSTRUCT_TEMPLATES.Where(x => x.ConstructType == ConstructType.PLAYER_ROCKET_SEEKING).Select(x => x.Uri).ToArray();
            ...
            _imageContainer.SetDropShadow(offsetX: 0, offsetY: 0, blurRadius: 6, color: "#e8e8e8");
