import { config } from "./package_2a3306d6aa3787ffa3787c6db8db899edaacb3d9//uno-config.js";
...
self.addEventListener('install', function (e) {
    ...
    e.waitUntil(
        caches.open('package_2a3306d6aa3787ffa3787c6db8db899edaacb3d9').then(async function (cache) {
